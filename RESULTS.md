...
6 GB Linux VM at 3 GB/s (`vm/five-gb.sh`): Qwen3.5-35B 3.5 tok/s, gpt-oss-20b 4.7, gpt-oss-120b 1.6. And with 16 GB
(15.5 GB free, 3 GB/s, plain): Qwen3.5-35B 8.5, gpt-oss-20b 14.1 (all its experts fit in the cache), gpt-oss-120b 4.1.
Every number in the app's estimate table is now measured. The app's recommendation table
