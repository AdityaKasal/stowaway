...
foreach ($leave in "4.5", "2.6") {
  ...
  Start-Sleep 60
  Get-Content "$t\lim-$leave.txt" -Tail 2
  Run "q35-$leave" @("run", "models\Qwen3.5-35B-A3B-Q5_K_M.gguf", "--packed", "E:\moe\35b-packed", "-n", "64", "-p", $story)
  if ($leave -eq "4.5") { Run "q122-$leave" @("run", "models\122b\Qwen3.5-122B-A10B-Q5_K_M-00001-of-00003.gguf", "--packed", "models\122b\experts-packed", "-n", "48", "-p", $story) }
